...
typedef FindOneAndReplaceDocumentRec = (FindAndModifyResult findAndModifyResult, MongoDocument serverDocument);

abstract class FindOneAndReplaceOperation extends FindAndModifyOperation {
  @protected
  ...
  factory FindOneAndReplaceOperation(
    ...
    if (collection.serverApi != null) {
      switch (collection.serverApi!.version) {
        case ServerApiVersion.v1:
          return FindOneAndReplaceOperationV1(
              collection, 
               query, replacement,
      fields: fields,
      sort: sort,
      ...
      returnNew: returnNew,
      session: session,
      findOneAndReplaceOptions: findOneAndReplaceOptions?.toFindOneAndReplaceOptionsV1,
      hint: hint,     
    ...
    return FindOneAndReplaceOperationOpen(
                    collection, 
               query, replacement,
      fields: fields,
      sort: sort,
      ...
      returnNew: returnNew,
      session: session,
      findOneAndReplaceOptions: findOneAndReplaceOptions?.toFindOneAndReplaceOptionsOpen,
      hint: hint,     
      rawOptions: rawOptions);
  }
